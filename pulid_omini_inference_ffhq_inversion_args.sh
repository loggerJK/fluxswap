# CUDA_VISIBLE_DEVICES=0 python pulid_omini_inference_ffhq_inversion_args.py \
...
CUDA_VISIBLE_DEVICES=2 python pulid_omini_inference_ffhq_inversion_args.py \
...
# CUDA_VISIBLE_DEVICES=3 python pulid_omini_inference_ffhq_inversion_args.py \
